...
- **Traceable readings**: 789 rules, each citing its classical source (三命通会 / 渊海子平 / 滴天髓 / 子平真诠 / 穷通宝鉴) plus a practical suggestion
...
- **Runtime**: `ui/index.html` — single file, zero external dependencies, 206 years of solar-term data + 789-rule database inlined
...
kb/          Classical texts + rule handbooks + 789-rule database
```
